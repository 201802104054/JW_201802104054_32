...
public class TeacherController extends HttpServlet {
    //请使用以下JSON测试增加功能
    //{"name":"王磊","profTitle":{"id":1},"degree":{"id":1},"department":{"id":1}}
    //请使用以下JSON测试修改功能
    //{"name":"李军","profTitle":{"id":1},"degree":{"id":1},"department":{"id":1},"id":1}

    /**
     * POST, http://49.235.2.175:8080/bysj/teacher.ctl, 增加教师
    ...
    /**
     * DELETE, http://49.235.2.175:8080/bysj/teacher.ctl?id=1, 删除id=1的教师
    ...
    /**
     * PUT, http://49.235.2.175:8080/bysj/teacher.ctl, 修改教师
     *
    ...
    /**
     * GET, http://49.235.2.175:8080/bysj/teacher.ctl?id=1, 查询id=1的教师
     * GET, http://49.235.2.175:8080/bysj/teacher.ctl, 查询所有的教师
     * 把一个或所有教师对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
